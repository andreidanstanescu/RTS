...
namespace RTS {
    public static class SaveManager {
        ...
        public static void SaveWorldObject(JsonWriter writer, World worldObject) {
        ...
        public static void SavePlayerResources(JsonWriter writer, Dictionary< string, int > resources) {
            if(writer == null) return;
        ...
        public static void SavePlayerUnits(JsonWriter writer, Vehicle[] units) {
            if(writer == null) return;
